...
export type ExcelSubtaskAssignee = {
  id: string;
  subtaskId: string;
  teamMemberId: string;
  sortOrder: number;
...
const subtaskAssigneesTable = new ExcelTable<ExcelSubtaskAssignee>("SubtaskAssignees", [
  "id",
  "subtaskId",
  "teamMemberId",
  "sortOrder",
...
function subtasksForTask(
  ...
  taskId: string,
  subtaskAssignments: ExcelSubtaskAssignee[] = [],
...
async function loadSubtaskWithAssignees(subtask: ExcelSubtask) {
